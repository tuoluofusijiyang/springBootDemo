...
<head>
    ...
    <!-- webuploader-->
    <link rel="stylesheet" href="${base}/${skin}/css/plugins/webuploader/webuploader.css">
    <link rel="stylesheet" href="${base}/${skin}/css/demo/webuploader-demo.css">
            ...
            <div class="ibox">
                <div class="ibox-content tabs-container">
                    ...
                    <ul id="tabnav" class="nav nav-tabs">
                        <li id='li_1' style='cursor: pointer;'
                            <c:if test="${type == 1}">class='nav_1 active'</c:if> onclick='changeTab(this)'>
                        ...
                        <!--
						 ...
						 -->
                        <li id='li_3' style='cursor: pointer;'
                            <c:if test="${type == 3}">class='nav_1'</c:if> onclick='changeTab(this)'>
                            ...
                            <div class="panel-body clearfix">
                                <div class="form-group">
                                    <label class="col-sm-2 control-label">
                                        <msg:message code='attribute.value.source.dictionary.type'/><msg:message
                                            code="system.common.sign.colon"/>
                                    </label>
                                    ...
                                    <div class="col-sm-3">
                                        <select id='dictionaryValue' style='width:80%;'>
                                            <c:forEach var="dictionary" items="${dictionaryList}">
                                                <option
                                                        <c:if test="${type == 1 && value ==dictionary.code}">selected</c:if>
                                                        value="${dictionary.code}">${dictionary.name}</option>
                                            </c:forEach>
                                        </select>
                                    </div>
                                </div>
                    ...
                    <div class="form-group">
                        <div class="col-sm-4 col-sm-offset-3">
                            <span id='errorValueMessage' style='color:red;'></span>&nbsp;&nbsp;&nbsp;<input type='button' value='<msg:message code='button.save'/>' class='boxy-btn1'  style='cursor:pointer' onclick='submit();'/>
                        </div>
                    </div>
